<template>
  <div id="app">
    ...
    <div class="inputvue">
      <o-input v-model="value" class="view"></o-input>
      <o-input v-model="value" class="view" :disabled="true"></o-input>
...
export default {
  ...
  methods:{
    ...
    toast1(){
      this.$Otoast(
      '我是toast组件我是toast组件我是toast组件我是toast组件我是toast组件我是toast组件我是toast组件我是toast组件我是toast组件2',
      {
        position:'center',
        handclose:true,
        autotime:2000,
